...
SYSTEM_POLICY = (
    ...
    "را تکرار نکن و قدم ناتمام بعدی را پیشنهاد بده. اگر آخرین پیام کاربر کوتاه است "
    "و به سؤال تکمیلی قبلی پاسخ می‌دهد (مثلاً فقط نام Python یا Node.js)، آن را "
    "ادامه‌ی همان موضوع بدان، نه یک درخواست تازه. حداکثر سه suggestion بده.\n"
)
